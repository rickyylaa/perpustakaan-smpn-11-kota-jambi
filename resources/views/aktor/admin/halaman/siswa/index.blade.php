                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="POST" action="{{ route('admin.siswaDestroy', $row->nisn) }}" id="delete-form-{{ $row->nisn }}">
                                                        @csrf @method('DELETE')
                                                        <a href="{{ route('admin.siswaShow', $row->id) }}" target="_blank" class="text-reset fs-21 fs px-1" title="Cetak">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="{{ route('admin.siswaUpdate', $row->nisn) }}" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <label for="nisn" class="form-label">Nomor Induk Siswa</label>
                                                                            <input type="number" name="nisn" id="nisn" class="form-control" value="{{ old('nisn', $row->nisn) }}" placeholder="Masukan nomor induk siswa" required autofocus>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', $row->tanggal_lahir) }}" required>
                ...
                <form method="POST" action="{{ route('admin.siswaStore') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="nisn" class="form-label">Nomor Induk Siswa</label>
                                <input type="number" name="nisn" id="nisn" class="form-control" value="{{ old('nisn') }}" placeholder="Masukan nomor induk siswa" required autofocus>
                                <p class="text-danger fs-16">{{ $errors->first('nisn') }}</p>
                            </div>
                            <div class="col-md-6">
                                <label for="nama" class="form-label">Nama</label>
