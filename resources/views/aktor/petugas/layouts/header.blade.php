    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            <div class="logo-topbar">
                <a href="{{ route('petugas.dashboard') }}" class="logo-light">
                    <span class="logo-lg">
                        <h3 class="text-center text-white ms-1 mb-1">PERPUSTAKAAN</h3>
                        <h3 class="text-center text-white ms-1 mb-0">SMPN 11 KOTA JAMBI</h3>
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo/logo.png') }}" alt="small logo">
                    </span>
                </a>
                <a href="{{ route('petugas.dashboard') }}" class="logo-dark">
                    <span class="logo-lg">
                        <h3 class="text-center text-white ms-1 mb-1">PERPUSTAKAAN</h3>
                        <h3 class="text-center text-white ms-1 mb-0">SMPN 11 KOTA JAMBI</h3>
                    </span>
